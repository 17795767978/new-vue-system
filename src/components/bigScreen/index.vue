...
export default {
  ...
  methods: {
    ...
    noCache () {
      ...
      let viewsArr = this.$store.state.views.visitedViews.filter(item => item.name !== 'bigHomeScreen')
      let cachedViews = this.$store.state.views.cachedViews.filter(item => item !== 'bigHomeScreen')
