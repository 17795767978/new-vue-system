  ...
  methods: {
    ...
    getExcel () {
      ...
      this.$api[`${this.downLoadName}`]({
        ...
        startTime: this.select ? moment(this.select.date[0]).format('YYYY-MM-DD HH:mm:ss') : moment(this.formInline.dateArray[0]).format('YYYY-MM-DD HH:mm:ss'),
        endTime: this.select ? moment(this.select.date[1]).format('YYYY-MM-DD HH:mm:ss') : moment(this.formInline.dateArray[1]).format('YYYY-MM-DD HH:mm:ss'),
        data: this.formDown,
