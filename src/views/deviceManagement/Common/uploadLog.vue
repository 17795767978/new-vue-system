...
export default {
  ...
  methods: {
    ...
    initTime () {
      ...
      this.searchForm.notifyTime = [moment(startTime).format('YYYY-MM-DD 00:00:00'), moment(startTime).format('YYYY-MM-DD 23:59:59')]
      this.searchForm.mdStartDate = moment(startTime).format('YYYY-MM-DD 00:00:00')
      this.searchForm.mdEndDate = moment(startTime).format('YYYY-MM-DD 23:59:59')
    },
    // 转换查询参数为后端需要的参数格式
    convertSearchParams () {
