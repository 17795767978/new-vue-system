    ...
    <el-dialog title="报警处理" :visible.sync="dialogFormVisible" :close-on-click-modal="false" width="30%">
      <el-form :model="form" :rules="rules" ref="ruleForm">
        <el-form-item label="操作类型" prop="handleType">
          <el-select v-model="form.handleType" placeholder="请选择操作类型">
            <el-option label="审核" value="2"></el-option>
            <el-option label="处理" value="1"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="处理类型" prop="handleStatus">
          <el-select v-model="form.handleStatus" placeholder="请选择处理类型">
            <el-option label="已处理" value="1"></el-option>
            <el-option label="误报" value="2"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="是否禁用" prop="handleIsvalid">
          <el-select v-model="form.handleIsvalid" placeholder="请选择处理状态">
            <el-option label="禁用" value="0"></el-option>
            <el-option label="启用" value="1"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item :label="form.handleType === '2' ? '审核意见' : '处理意见'" prop="hContext">
          <el-input type="textarea" v-model="form.handleContext" style="width: 70%;" maxlength="100" :autosize="{ minRows: 2, maxRows: 7}"></el-input>
        </el-form-item>
      </el-form>
