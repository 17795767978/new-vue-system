...
export const aysncRoutesMap = [
  {
    ...
    children: [{
      path: 'integrated-monitoring-home',
      component: _import_('newBigScreen/index'),
      meta: {
        title: '综合监控首页',
        icon: 'nocturne icon-dash',
  ...
  },
  {
    ...
    meta: {
      title: '安全运营',
      icon: 'nocturne icon-dash',
      roles: ['/alarm-center', '/alarm-home', '/alarm-analysis']
    },
    children: [
      {
        path: 'alarm-home',
        component: _import_('safeOperation/alarmHome/index'),
        name: 'alarmHome',
        meta: {
          title: '安全运营首页',
          icon: 'nocturne icon-dash',
      ...
      {
        path: '/alarm-center',
        component: _import_('safeOperation/alarmCenter/index'),
        name: 'alarmCenter',
        meta: {
          title: '报警中心',
          icon: 'nocturne icon-dash',
          roles: ['/driver-check', '/monitoring-ledger', '/diary-table', '/equipment-capture', '/device-snap-management']
        },
        children: [
          {
            path: 'driver-check',
            component: _import_('safeOperation/alarmCenter/driverCheck/index'),
            name: 'driverCheck',
            meta: {
              title: '驾驶行为监测',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'driver-check-detail',
            component: _import_('safeOperation/alarmCenter/driverCheck/driverCheckDetail/index'),
            name: 'driverCheckDetail',
            hidden: true,
            meta: {
              title: '驾驶行为监测详情',
              icon: 'nocturne icon-dash'
          ...
          {
            path: 'monitoring-ledger',
            component: _import_('safeOperation/alarmCenter/monitoringLedger/index'),
            name: 'monitoringLedger',
            meta: {
              title: '驾驶行为监测台账',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'diary-table',
            component: _import_('safeOperation/alarmCenter/diaryTable/index'),
            name: 'diaryTable',
            meta: {
              title: '统计日报表',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'equipment-capture',
            component: _import_('safeOperation/alarmCenter/equipmentCapture/index'),
            name: 'equipmentCapture',
            meta: {
              title: '设备抓拍',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'device-snap-management',
            component: _import_('safeOperation/alarmCenter/deviceSnapManagement/index'),
            name: 'deviceSnapManagement',
            meta: {
              title: '设备抓拍配置',
              icon: 'nocturne icon-dash',
      ...
      {
        path: '/alarm-analysis',
        component: _import_('safeOperation/alarmAnalysis/index'),
        name: 'alarmAnalysis',
        meta: {
          title: '报警分析',
          icon: 'nocturne icon-dash',
          roles: ['/driver-sort', '/car-sort', '/alarm-type-analysis']
        },
        children: [
          {
            path: 'driver-sort',
            component: _import_('safeOperation/alarmAnalysis/driverSort/index'),
            name: 'driverSort',
            meta: {
              title: '司机排行',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'car-sort',
            component: _import_('safeOperation/alarmAnalysis/carSort/index'),
            name: 'carSort',
            meta: {
              title: '车辆排行',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'alarm-type-analysis',
            component: _import_('safeOperation/alarmAnalysis/alarmTypeAnalysis/index'),
            name: 'alarmTypeAnalysis',
            meta: {
              title: '报警类型分析',
              icon: 'nocturne icon-dash',
              roles: ['/alarm-type-analysis']
            }
          },
          {
            path: 'alarm-speed-analysis',
            component: _import_('safeOperation/alarmAnalysis/alarmSpeedAnalysis/index'),
            name: 'alarmSpeedAnalysis',
            meta: {
              title: '报警速度分析',
              icon: 'nocturne icon-dash',
              roles: ['/alarm-speed']
  ...
  },
  {
    ...
    meta: {
      title: '客流分析',
      icon: 'nocturne icon-dash',
      roles: ['/passenger-home', '/data-query', '/passeger-data-analysis', '/realtime-passenger-flow']
    },
    children: [
      {
        path: 'passenger-home',
        component: _import_('passengerFlowAnalysis/passengerHome/index'),
        name: 'passengerHome',
        meta: {
          title: '客流分析首页',
          icon: 'nocturne icon-dash',
      ...
      {
        path: 'realtime-passenger-flow',
        component: _import_('passengerFlowAnalysis/realtimePassengerFlow/index'),
        name: 'realtimePassengerFlow',
        meta: {
          title: '客流实时统计',
          icon: 'nocturne icon-dash',
      ...
      {
        path: '/data-query',
        component: _import_('passengerFlowAnalysis/dataQuery/index'),
        meta: {
          title: '数据查询',
          icon: 'nocturne icon-dash',
          roles: ['/search-passenger-flow', '/search-passenger-detail', '/bus-passenger', '/line-passenger-flow', '/comprehensive-query']
        },
        children: [
          {
            path: 'search-passenger-flow',
            component: _import_('passengerFlowAnalysis/dataQuery/searchPassengerFlow/index'),
            name: 'searchPassengerFlow',
            meta: {
              title: '客流数据查询',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'search-passenger-detail',
            component: _import_('passengerFlowAnalysis/dataQuery/searchPassengerDetail/index'),
            name: 'searchPassengerDetail',
            meta: {
              title: '客流数据明细查询',
              icon: 'nocturne icon-dash',
              roles: ['/search-passenger-detail']
            }
          },
          {
            path: 'bus-passenger',
            component: _import_('passengerFlowAnalysis/dataQuery/busPassenger/index'),
            name: 'busPassenger',
            meta: {
              title: '单车客流统计',
              icon: 'nocturne icon-dash',
          ...
          },
          {
            ...
            component: _import_('passengerFlowAnalysis/dataQuery/linePassengerFlow/index'),
          ...
          {
            path: 'comprehensive-query',
            component: _import_('passengerFlowAnalysis/dataQuery/comprehensiveQuery/index'),
            name: 'comprehensiveQuery',
            meta: {
              title: '线路站点客流查询',
              icon: 'nocturne icon-dash',
      ...
      {
        path: '/passeger-data-analysis',
        component: _import_('passengerFlowAnalysis/passengerDataAnalysis/index'),
        name: 'passengerDataAnalysis',
        meta: {
          title: '客流分析',
          icon: 'nocturne icon-dash',
          roles: ['timeTable-analysis', '/section-analysis', '/full-load-rate', '/landing-volume', '/passenger-transport-capacity', '/simple-passenger-flow']
        },
        children: [
          {
            path: 'timeTable-analysis',
            component: _import_('passengerFlowAnalysis/passengerDataAnalysis/timeTableAnalysis/index'),
            name: 'timeTableAnalysis',
            meta: {
              title: '客流高峰时刻分析',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'section-analysis',
            component: _import_('passengerFlowAnalysis/passengerDataAnalysis/sectionAnalysis/index'),
            name: 'sectionAnalysis',
            meta: {
              title: '客流高峰断面分析',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'full-load-rate',
            component: _import_('passengerFlowAnalysis/passengerDataAnalysis/fullLoadRate/index'),
            name: 'fullLoadRate',
            meta: {
              title: '区间满载率查询',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'landing-volume',
            component: _import_('passengerFlowAnalysis/passengerDataAnalysis/landingVolume/index'),
            name: 'landingVolume',
            meta: {
              title: '站点登降量查询',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'passenger-transport-capacity',
            component: _import_('passengerFlowAnalysis/passengerDataAnalysis/passengerTransportCapacity/index'),
            name: 'passengerTransportCapacity',
            meta: {
              title: '客流运力运量分析',
              icon: 'nocturne icon-dash',
          ...
          },
          {
            ...
            component: _import_('passengerFlowAnalysis/passengerDataAnalysis/simplePassengerFlow/index'),
      ...
      {
        path: '/od-data-analysis',
        component: _import_('passengerFlowAnalysis/ODDataAnalysis/index'),
        name: 'ODAnalysis',
        meta: {
          title: 'OD分析',
          icon: 'nocturne icon-dash',
          roles: ['/passenger-hotmap-analysis', '/passenger-hotmap-analysis', '/city-od']
        },
        children: [
          {
            path: 'passenger-hotmap-analysis',
            component: _import_('passengerFlowAnalysis/ODDataAnalysis/passengerHotmapAnalysis/index'),
            name: 'timeTableAnalysis',
            meta: {
              title: '客流热力分析',
              icon: 'nocturne icon-dash',
              roles: ['/passenger-hotmap-analysis']
            }
          },
          {
            path: 'line-od-analysis',
            component: _import_('passengerFlowAnalysis/ODDataAnalysis/lineODAnalysis/index'),
            name: 'lineODAnalysis',
            meta: {
              title: '线路OD',
              icon: 'nocturne icon-dash',
              roles: ['/line-od-analysis']
            }
          },
          {
            path: 'city-od',
            component: _import_('passengerFlowAnalysis/ODDataAnalysis/cityOD/index'),
            name: 'cityOD',
            meta: {
              title: '城市OD矩阵',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'city-od-map',
            component: _import_('passengerFlowAnalysis/ODDataAnalysis/cityODMap/index'),
            name: 'cityODMap',
            meta: {
              title: '城市OD电子地图',
              icon: 'nocturne icon-dash',
  ...
  {
    path: '/line-net-evaluation',
    component: Layout,
    meta: {
      title: '线网评价',
      icon: 'nocturne icon-dash',
      roles: ['/line-net-home', '/line-net-rating']
    },
    children: [
      {
        path: 'line-net-home',
        component: _import_('lineNetEvaluation/lineNetHome/index'),
        name: 'lineNetHome',
        meta: {
          title: '首页',
          icon: 'nocturne icon-dash',
      ...
      {
        path: '/line-net-rating',
        component: _import_('lineNetEvaluation/lineNetRating/index'),
        name: 'lineNetRating',
        meta: {
          title: '线网评分',
          icon: 'nocturne icon-dash',
          roles: ['/line-network-core', '/line-netWork-core-Detail', '/repeatability-index', '/repeatability-detail']
        },
        children: [
          {
            path: 'line-network-core',
            component: _import_('lineNetEvaluation/lineNetRating/lineNetworkCore/index'),
            name: 'lineNetworkCore',
            meta: {
              title: '线网评分',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'line-netWork-core-Detail',
            component: _import_('lineNetEvaluation/lineNetRating/lineNetWorkDetail/index'),
            name: 'lineNetWorkDetail',
            meta: {
              title: '线网评分详情',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'repeatability-index',
            component: _import_('lineNetEvaluation/lineNetRating/repeatability/index'),
            name: 'repeatability',
            meta: {
              title: '重复度指标',
              icon: 'nocturne icon-dash',
          ...
          {
            path: 'repeatability-detail',
            component: _import_('lineNetEvaluation/lineNetRating/repeatDetail/index'),
            name: 'repeatabilityDetail',
            meta: {
              title: '重复度指标详情',
              icon: 'nocturne icon-dash',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'alarm-management',
        component: _import_('systemAdmin/alarmManagement/index'),
        name: 'alarmManagement',
        meta: {
          title: '报警类型管理',
          icon: 'nocturne icon-dash',
      ...
      {
        path: 'device-status',
        component: _import_('systemAdmin/deviceStatus/index'),
        name: 'deviceStatus',
        meta: {
          title: '设备状态',
          icon: 'nocturne icon-dash',
      ...
      {
        path: 'user-result',
        component: _import_('systemAdmin/userCheckResult/index'),
        name: 'userCheckResult',
        meta: {
          title: '用户处理结果',
          icon: 'nocturne icon-dash',
      ...
      {
        path: 'device-parameter',
        component: _import_('systemAdmin/deviceParameter/index'),
        name: 'deviceParameter',
        meta: {
          title: '设备参数下发',
          icon: 'nocturne icon-dash',
